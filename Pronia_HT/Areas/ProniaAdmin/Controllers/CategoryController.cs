...
namespace Pronia_HT.Areas.ProniaAdmin.Controllers
{
    ...
    public class CategoryController : Controller
    {
        ...
        {
            Models.Category category = await _context.Categories.FirstOrDefaultAsync(ca => ca.Id == id);
        ...
        {
            Models.Category existedCategory = await _context.Categories.FirstOrDefaultAsync(c => c.Id == id);
